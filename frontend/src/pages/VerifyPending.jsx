  ...
  return (
    <div className="main-centered-content">
      <div className="verify-page-container">
        ...
        <p>
          {email ? (
            <>To activate your account, check your inbox for a verification email sent to <b>{email}</b>.</>
          ) : (
            <>To activate your account, please check your email for a verification link.</>
          )}
        </p>
        <form onSubmit={handleResend} style={{ width: "100%", textAlign: "center" }}>
          <button
            type="submit"
